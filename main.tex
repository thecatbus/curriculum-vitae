...
\begin{longtable}{>{\raggedleft\arraybackslash}p{0.8in}>{}p{0.05in}>{}p{5.7in}}
	...
	\hfill 2025                                                                            \\
	 &  & (Joint with F. Sala and O. Schiffmann) \emph{Preprint.}
	\href{https://arxiv.org/abs/2511.08576}{arXiv:2511.08576}
	\nextSection%
     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Olympiad. \hfill 2020, 2021\nextSection%
     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \pagebreak
	\multirow{2}{0.8in}{\raggedleft\arraybackslash Suggested referees}%
     &  & \textbf{Prof.\ Michael Wemyss} (\emph{Ph.D. advisor})  \hfill
     University of Glasgow \\
     &  & \texttt{michael.wemyss@glasgow.ac.uk} \\\\[-0.6em]
     &  & \textbf{Prof.\ Olivier Schiffmann}  \hfill
     Universit\'e de Paris-Saclay \\
     &  & \texttt{olivier.schiffmann@universite-paris-saclay.fr} \\\\[-0.6em]
     &  & \textbf{Prof.\ Ailsa Keating}  \hfill
     University of Cambridge \\
     &  & \texttt{amk50@cam.ac.uk} \\\\[-0.6em]
     &  & \textbf{Prof.\ Hokuto Uehara}  \hfill
     Tokyo Metropolitan University \\
     &  & \texttt{hokuto@tmu.ac.jp} \\\\[-0.6em]
     &  & \textbf{Dr.\ Jon Woolf}  \hfill
     University of Liverpool \\
     &  & \texttt{jonathan.woolf@liverpool.ac.uk} \\\\[-0.6em]
     &  & \textbf{Prof.\ Dhruv Ranganathan} (\emph{teaching reference})  \hfill
     University of Cambridge \\
     &  & \texttt{dr508@cam.ac.uk} \\\\[1em]
     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     Citizenship 
     &  &  Indian\nextItem%
     Languages 
     &  & English (\emph{native}), Marathi (\emph{native}), 
     Hindi (\emph{fluent}) \nextItem%
     Email 
     &  &  \href{mailto:pas201@srcf.net}{\texttt{pas201@srcf.net}}
     (\emph{personal}) \\
     &  &
     \href{mailto:parth.shimpi@glasgow.ac.uk}{\texttt{parth.shimpi@glasgow.ac.uk}}
     (\emph{work})\nextItem%
     Webpage 
     &  &
     \href{https://pas201.user.srcf.net}{\texttt{pas201.user.srcf.net}}\nextItem%
\end{longtable}
\end{document}
